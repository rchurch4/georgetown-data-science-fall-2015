...
#
# Note on order:
# In general, data preparation scripts should be
# run in the following order, for corresponding
# input data files: 
    # 1) json_to_csv_yelp.py
    # 2) update_geocode_lookup_table.py
    # 3) clean_and_feature_generation_yelp_multiple.py
...
# 
# Example: input_file_paths = ['data/yelp_dc_1.csv', 'data/yelp_dc_2.csv']
################
